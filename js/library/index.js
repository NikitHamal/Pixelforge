...
PF.Library = (() => {
  ...
  function registerAll() {
    ...
    add('iso_blocks', 'Iso Blocks', 'World', 'Eight stackable isometric cubes lit from the upper left: turf-lipped grass, stone, dirt, sand, ice, coursed brick, a braced crate and a gold bar.', ['isometric', 'block', 'cube', 'terrain', 'voxel'], () => IS().blocksSuite(), { w: 32, h: 32, featured: true });
    ...
    add('iso_stairs', 'Iso Stairs & Ramps', 'World', 'Five level-connectors built on the same footprint: four-tread stairs on each axis, a timber flight, a twelve-slice dirt ramp and a low platform.', ['isometric', 'stairs', 'ramp', 'level', 'terrain'], () => IS().stairsSuite(), { w: 32, h: 32 });
    add('iso_props', 'Iso Props', 'World', 'Ten isometric set pieces on their own ground tile: broadleaf tree, snowy pine, boulder, barrel, chest, flickering lamp, berry bush, pulsing crystal, a fence run and a signpost.', ['isometric', 'props', 'scenery', 'decoration', 'world'], () => IS().propsSuite(), { w: 32, h: 32, featured: true });
